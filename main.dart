      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            const CircleAvatar(
              radius: 80,
              backgroundImage: AssetImage('assets/afa.jpg'),
            ),
            const SizedBox(height: 20),
            Text(
              'M. Rizki Syahril Afwa',
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                      ...
                      subtitle: const Text('03 Desember 2002'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      leading: const Icon(Icons.web, color: Colors.blue),
                      title: const Text('Website'),
                      subtitle: const Text('syahrilafwa29.com'),
                      onTap: () {},
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
                      ...
                      subtitle: const Text('syahrilafwa29@gmail.com'),
                    ),
                    Divider(color: Colors.grey.shade300, thickness: 1),
                    ListTile(
            ...
            _buildInformationCard(context, 'Work Experience', [
              _buildListTile(Icons.work, 'Internship', 'MSIB (2024)'),
              _buildListTile(Icons.code, 'Freelance', 'Game Development (2024)'),
            ]),
            const SizedBox(height: 20),
            _buildInformationCard(context, 'Hobbies', [
              _buildListTile(Icons.music_note, 'Musik', 'Desember - Neck Deep'),
              _buildListTile(Icons.directions_bike, 'Olahraga', 'Gym'),
              _buildListTile(Icons.movie, 'Film', 'Animek'),
            ]),
            const SizedBox(height: 20),
            Row(
